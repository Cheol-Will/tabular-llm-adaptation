...
class LLMBaselineModel(AbstractModel):
    ag_key = "LLMBaseline"
    ag_name = "LLMBaseline"
    _model_cls = LLMBaseline
    ...
    def _fit(
        ...
        **kwargs,
        ...
        from .engine import LLMBaselineImplementation
        ...
        self.model = LLMBaselineImplementation(
...
class LLMBaselineBidirectionalModel(LLMBaselineModel):
    ag_key = "LLMBaselineBidirectional"
    ag_name = "LLMBaselineBidirectional"
    _model_cls = LLMBaselineBidirectional


class LLMBaselinePoolingModel(LLMBaselineModel):
    ag_key = "LLMBaselinePooling"
    ag_name = "LLMBaselinePooling"
    _model_cls = LLMBaselinePooling


class LLMBaselineBidirectionalPoolingModel(LLMBaselineModel):
    ag_key = "LLMBaselineBidirectionalPooling"
    ag_name = "LLMBaselineBidirectionalPooling"
    _model_cls = LLMBaselineBidirectionalPooling


class LLMRead(LLMBaselineModel):
    ag_key = "LLMRead"
    ag_name = "LLMRead"
    _model_cls = LLMRead

class LLMReadPred(LLMBaselineModel):
    ag_key = "LLMReadPred"
    ag_name = "LLMReadPred"
    _model_cls = LLMReadPred