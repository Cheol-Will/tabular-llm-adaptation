...
class LLMAdapterEngineeredModel(AbstractModel):
    ag_key = "LLMAdapterEngineered"
    ag_name = "LLMAdapterEngineered"
    ...
    def _fit(
        ...
        **kwargs,
        ...
        from .engine import LLMAdapterEngineeredImplementation
