...
class FTTransformerModel(AbstractModel):
    ...
    def _fit(
        ...
        **kwargs,
        ...
        from .engine import FTTransformerImplementation
    ...
    def _predict_proba(self, X: pd.DataFrame, **kwargs) -> pd.DataFrame:
        ...
        if self.problem_type == 'regression':
            return (
                preds.squeeze(-1).cpu().numpy() * self.model.y_std_ + self.model.y_mean_
            )
    ...
    def _preprocess(
        ...
        **kwargs,
        ...
        if is_train:
            ...
            # Identify numerical features for mean imputation
        ...
        # Apply imputation to ensure no missing values reach the MLP
        ...
        # Force boolean flags to categorical to leverage embedding layers
