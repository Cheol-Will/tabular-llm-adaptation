...
class LLMSlotBoostModel(AbstractModel):
    ag_key = "LLMSlotBoost"
    ag_name = "LLMSlotBoost"
    ...
    def _fit(
        ...
        **kwargs,
        ...
        from .engine import LLMSlotBoostImplementation
        ...
        self.model = LLMSlotBoostImplementation(
    ...
    def get_attn_map(self, X: pd.DataFrame, **kwargs):
