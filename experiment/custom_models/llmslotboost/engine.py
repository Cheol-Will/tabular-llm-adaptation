...
from .model import LLMSlotBoost
...
def _ddp_worker(
    ...
    model = LLMSlotBoost(
        ...
        bins=bins,
        num_boosting=config.get("num_boosting", 4),
        boosting_token=config.get("boosting_token", "eos"),
    ).to(device)
...
class LLMSlotBoostImplementation:
    ...
    def fit(
        ...
        self.column_ids_ = column_ids
        self.column_ids_lengths_ = column_ids_lengths
        del tokenizer
