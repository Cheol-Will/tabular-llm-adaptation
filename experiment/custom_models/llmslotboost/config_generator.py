...
from .wrapper import LLMSlotBoostModel
...
def get_experiment_configs(
    ...
    """
    Generate the hyperparameter configurations to run for LLMSlotBoost.
    ...
    manual_configs = [
        {
            ...
            "num_boosting": args.num_boosting,
            "boosting_token": args.boosting_token,
    ...
    gen = ConfigGenerator(
        model_cls=LLMSlotBoostModel,
        manual_configs=manual_configs,
        search_space=search_space,
        name=f"LLMSlotBoost_{exp_name}",
    )
